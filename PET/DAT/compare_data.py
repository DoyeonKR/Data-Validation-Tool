...
def compare_data(csv_df, excel_df_filtered):
    ...
    rois = [
        ...
        'Left Caudate SUVR',
        'Right Caudate SUVR',
        'Total Anterior Caudate SUVR',
        'Left Anterior Caudate SUVR',
        'Right Anterior Caudate SUVR',
        'Total Posterior Caudate SUVR',
        'Left Posterior Caudate SUVR',
        'Right Posterior Caudate SUVR',
        'Total Putamen SUVR',
        'Left Putamen SUVR',
        'Right Putamen SUVR',
        'Total Anterior Putamen SUVR',
        'Left Anterior Putamen SUVR',
        'Right Anterior Putamen SUVR',
        'Total Posterior Putamen SUVR',
        'Left Posterior Putamen SUVR',
        'Right Posterior Putamen SUVR',
        'Total Ventral Putamen SUVR',
        'Left Ventral Putamen SUVR',
        'Right Ventral Putamen SUVR',
        'Total Ventral Striatum SUVR',
        'Left Ventral Striatum SUVR',
        'Right Ventral Striatum SUVR',
    ]
