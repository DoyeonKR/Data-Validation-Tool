...
def compare_data(csv_df, excel_df_filtered):
    ...
    rois = [
        'Total Braak ROI Global SUVR',
        'Left Braak ROI Global SUVR',
        'Right Braak ROI Global SUVR',
        'Total Braak I/II ROI SUVR',
        'Left Braak I/II ROI SUVR',
        'Right Braak I/II ROI SUVR',
        'Total Braak I ROI SUVR',
        'Left Braak I ROI SUVR',
        'Right Braak I ROI SUVR',
        'Total Braak II ROI SUVR',
        'Left Braak II ROI SUVR',
        'Right Braak II ROI SUVR',
        'Total Braak III/IV ROI SUVR',
        'Left Braak III/IV ROI SUVR',
        'Right Braak III/IV ROI SUVR',
        'Total Braak III ROI SUVR',
        'Left Braak III ROI SUVR',
        'Right Braak III ROI SUVR',
        'Total Braak IV ROI SUVR',
        'Left Braak IV ROI SUVR',
        'Right Braak IV ROI SUVR',
        'Total Braak V/VI ROI SUVR',
        'Left Braak V/VI ROI SUVR',
        'Right Braak V/VI ROI SUVR',
        'Total Braak V ROI SUVR',
        'Left Braak V ROI SUVR',
        'Right Braak V ROI SUVR',
        'Total Braak VI ROI SUVR',
        'Left Braak VI ROI SUVR',
        'Right Braak VI ROI SUVR',
        'Total A Priori ROI SUVR',
        'Left A Priori ROI SUVR',
        'Right A Priori ROI SUVR',
